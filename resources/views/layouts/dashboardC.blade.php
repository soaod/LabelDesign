    ...
    <div class="container-fluid-fluid px-10">
        ...
        <div class="collapse navbar-collapse" id="mobile-menu">
            ...
            <ul class="navbar-nav main-menu">
                ...
                <a class="nav-link dropdown-toggle gr-toggle-arrow" id="navbarDropdown" href="#features" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">الصفحة الرئيسية</a>
...
<div class="bg-white">
        ...
        <p class="mb-8">
            <a class="text-gray font-size-4" href="#">44XXXXXXX</a>
        </p>
        </div>
        </div>
        ...
        <li class=""><a href="dashboard-posted-jobs.html" class="px-10 py-1 my-5 font-size-4 font-weight-semibold flex-y-center"><i class="fas fa-briefcase mr-7"></i>العروض المقدمة</a></li>
        ...
        <li class=""><a href="./dashboard-settings.html" class="px-10 py-1 my-5 font-size-4 font-weight-semibold flex-y-center"><i class="fa-regular fa-hourglass-start"></i>الطلبات المرفوضة</a></li>
        <li class=""><a href="./dashboard-settings.html" class="px-10 py-1 my-5 font-size-4 font-weight-semibold flex-y-center"><i class="fas fa-cog mr-7"></i>الاعدادات</a></li>
    ...
    <div class="container">
        ...
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            ...
            <div class="text-blue bg-blue-opacity-1 circle-56 font-size-8 mr-7">
                <i class="fa-thin fa-bullseye-arrow"></i>           </div>
            <!-- Category Content -->
            <div class="">
                <h5 class="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1"><span class="counter">2</span></h5>
                <p class="font-size-4 font-weight-normal text-gray mb-0">العروض المقدمة</p>
            </div>
            </a>
            <!-- End Single Category -->
        </div>
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            ...
            <div class="">
                ...
                <p class="font-size-4 font-weight-normal text-gray mb-0">طلبات تحت الاجراء</p>
            </div>
            </a>
            <!-- End Single Category -->
        </div>
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            ...
            <!-- Category Content -->
            <div class="">
                <h5 class="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1"><span class="counter">4</span></h5>
                <p class="font-size-4 font-weight-normal text-gray mb-0">الطلبات المرفوضة</p>
            </div>
            </a>
            <!-- End Single Category -->
        </div>
        <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6">
            ...
            <!-- Category Content -->
            <div class="">
                <h5 class="font-size-8 font-weight-semibold text-black-2 line-height-reset font-weight-bold mb-1"><span class="number">5</span></h5>
                <p class="font-size-4 font-weight-normal text-gray mb-0">عدد المحلات </p>
            </div>
            </a>
            <!-- End Single Category -->
        </div>
        ...
        <div class="row mb-11 align-items-center">
            ...
            <h3 class="font-size-6 mb-0"> طلبات تحت الاجراء(4)</h3>
            </div>
            <div class="col-lg-6">
        ...
        <div class="bg-white shadow-8 pt-7 rounded pb-9 px-11">
            ...
            <table class="table table-striped">
                <thead>
                <tr>
                    <th scope="col" class="pl-0  border-0 font-size-4 font-weight-normal">اسم العميل</th>
                    <th scope="col" class="border-0 font-size-4 font-weight-normal"> رقم الطلب</th>
                    <th scope="col" class="border-0 font-size-4 font-weight-normal">التاريخ</th>
                    <th scope="col" class="border-0 font-size-4 font-weight-normal">التفاصيل</th>
                    <th scope="col" class="border-0 font-size-4 font-weight-normal">الحالة</th>
                ...
                <tbody>
                    ...
                    <th scope="row" class="pl-6 border-0 py-7 pr-0">
                        ...
                        <h4 class="font-size-4 mb-0 font-weight-semibold text-black-2">البيك</h4>
                        </a>
                    </th>
                    ...
                    <th scope="row" class="pl-6 border-0 py-7 pr-0">
                        ...
                        <h4 class="font-size-4 mb-0 font-weight-semibold text-black-2">الراجحي للمقاولات</h4>
                        </a>
                    </th>
                    <td class="table-y-middle py-7 min-width-px-235 pr-0">
                    ...
                    <th scope="row" class="pl-6 border-0 py-7 pr-0">
                        ...
                        <h4 class="font-size-4 mb-0 font-weight-semibold text-black-2"> بقالة الوفاء</h4>
                        </a>
                    </th>
                    <td class="table-y-middle py-7 min-width-px-235 pr-0">
                    ...
                    <th scope="row" class="pl-6 border-0 py-7 pr-0">
                        ...
                        <h4 class="font-size-4 mb-0 font-weight-semibold text-black-2"> ساحة الفيلق</h4>
                        </a>
                    </th>
                    <td class="table-y-middle py-7 min-width-px-235 pr-0">
